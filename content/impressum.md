...
date: 
layout: post
impressum1: "{{ .Site.Params.impressum1 }}"
---

**Angaben gemäß § 5 TMG:**

**{{< param name="impressum1" >}}**  
vertreten durch den Vorsitzenden  

<strong>{{< param name="impressum1" >}}<br>
{{< param name="impressum2" >}}<br>
{{< param name="impressum3" >}}<br>
{{< param name="impressum4" >}}<p>
{{< param name="impressum5" >}}</strong></p>

## Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV

{{< param name="impressum2" >}} (siehe oben)
